...
class CalendarDatePicker2Config {
  ...
  /// Custom icon for last year button control
  final Widget? lastYearIcon;
  ...
  /// Custom icon for next year button control
  final Widget? nextYearIcon;
  ...
  /// Custom text style for overRanged calendar day(s)
  final TextStyle? overRangedDayTextStyle;
  ...
  CalendarDatePicker2Config copyWith({
    ...
    TextStyle? overRangedDayTextStyle,
    ...
    return CalendarDatePicker2Config(
      ...
      overRangedDayTextStyle:
          overRangedDayTextStyle ?? this.overRangedDayTextStyle,
...
class CalendarDatePicker2WithActionButtonsConfig
  ...
  CalendarDatePicker2WithActionButtonsConfig({
    ...
    this.buttonPadding,
          ...
          overRangedDayTextStyle: overRangedDayTextStyle,
