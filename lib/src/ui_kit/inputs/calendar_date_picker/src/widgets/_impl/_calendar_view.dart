...
class _CalendarView extends StatefulWidget {
  ...
  final _DatePickerModeToggleButton title;
...
class _CalendarViewState extends State<_CalendarView> {
  ...
  void _handleNextYear() {
    if (!_isDisplayingLastMonth) {
      widget
          .onYearChanged(DateTime(_currentMonth.year + 1, _currentMonth.month));
    }
  }
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                IconButton(
                  icon: widget.config.lastYearIcon ??
                      const Icon(Icons.keyboard_double_arrow_left),
                  color: controlColor,
                  onPressed:
                      _isDisplayingFirstMonth ? null : _handlePreviousYear,
                ),
                IconButton(
                ...
                IconButton(
                  icon: widget.config.nextYearIcon ??
                      const Icon(Icons.keyboard_double_arrow_right),
                  color: controlColor,
                  onPressed: _isDisplayingFirstMonth ? null : _handleNextYear,
                ),
              ],
            ),
          ),
