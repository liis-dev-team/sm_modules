...
TextStyle _themeTextStyle(BuildContext context, {bool isValid = true}) {
  final TextStyle style = AT.t.b16;
  return isValid
      ? style.copyWith(
...
class _SelectionOverlay extends StatelessWidget {
  ...
  final Color? background = CupertinoColors.systemGrey2.withOpacity(0.1);
  ...
  static const double _defaultSelectionOverlayRadius = 16;
...
Widget _startSelectionOverlay = _SelectionOverlay(capEndEdge: false);
Widget _centerSelectionOverlay =
    _SelectionOverlay(capStartEdge: false, capEndEdge: false);
Widget _endSelectionOverlay = _SelectionOverlay(capStartEdge: false);
...
class _CupertinoDatePickerDateTimeState extends State<AppCupertinoDatePicker> {
  ...
  @override
  void didUpdateWidget(AppCupertinoDatePicker oldWidget) {
  ...
  double _getEstimatedColumnWidth(_PickerColumnType columnType) {
    if (estimatedColumnWidths[columnType.index] == null) {
      estimatedColumnWidths[columnType.index] =
          AppCupertinoDatePicker._getColumnWidth(
          ...
          return itemPositioningBuilder(
            ...
            Text(
                index == 0
                    ...
                    : localizations.postMeridiemAbbreviation,
                style: AT.t
                    .b16 //_themeTextStyle(context, isValid: _isValidHour(index, _selectedHourIndex)),
                ),
          );
        }),
      ),
...
class _CupertinoDatePickerDateState extends State<AppCupertinoDatePicker> {
  ...
  void _refreshEstimatedColumnWidths() {
    estimatedColumnWidths[_PickerColumnType.dayOfMonth.index] =
        AppCupertinoDatePicker._getColumnWidth(_PickerColumnType.dayOfMonth,
            localizations, context, widget.showDayOfWeek);
    estimatedColumnWidths[_PickerColumnType.month.index] =
        AppCupertinoDatePicker._getColumnWidth(_PickerColumnType.month,
            localizations, context, widget.showDayOfWeek);
    estimatedColumnWidths[_PickerColumnType.year.index] =
        AppCupertinoDatePicker._getColumnWidth(_PickerColumnType.year,
            localizations, context, widget.showDayOfWeek);
  }
...
class _CupertinoDatePickerMonthYearState extends State<AppCupertinoDatePicker> {
