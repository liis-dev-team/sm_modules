...
class AuthForm extends StatelessWidget {
  final Stream<String>? loginStream;
  final Stream<String?>? loginErrorStream;
  ...
  final void Function(String login)? onLoginChanged;
